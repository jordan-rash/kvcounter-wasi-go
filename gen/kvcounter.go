...
func WasiPollPollPollOneoff(in []uint32) []bool {
  var lower_in C.kvcounter_list_wasi_poll_poll_pollable_t
  if len(in) == 0 {
    lower_in.ptr = nil
    lower_in.len = 0
  } else {
  ...
  defer C.kvcounter_list_wasi_poll_poll_pollable_free(&lower_in)
  var ret C.kvcounter_list_bool_t
...
func WasiIoStreamsRead(this uint32, len uint64) Result[WasiIoStreamsTuple2ListU8TWasiIoStreamsStreamStatusT, struct{}] {
  ...
  var ret C.kvcounter_result_tuple2_list_u8_wasi_io_streams_stream_status_void_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.kvcounter_tuple2_list_u8_wasi_io_streams_stream_status_t)(unsafe.Pointer(&ret.val))
...
func WasiIoStreamsSkip(this uint32, len uint64) Result[WasiIoStreamsTuple2U64WasiIoStreamsStreamStatusT, struct{}] {
  ...
  lower_this = lower_this_val
  lower_len := C.uint64_t(len)
  var ret C.kvcounter_result_tuple2_u64_wasi_io_streams_stream_status_void_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.kvcounter_tuple2_u64_wasi_io_streams_stream_status_t)(unsafe.Pointer(&ret.val))
...
func WasiIoStreamsWrite(this uint32, buf []uint8) Result[WasiIoStreamsTuple2U64WasiIoStreamsStreamStatusT, struct{}] {
  ...
  lower_this_val := C.uint32_t(this)
  lower_this = lower_this_val
  var lower_buf C.kvcounter_list_u8_t
  if len(buf) == 0 {
    lower_buf.ptr = nil
    lower_buf.len = 0
  } else {
  ...
  defer C.kvcounter_list_u8_free(&lower_buf)
  var ret C.kvcounter_result_tuple2_u64_wasi_io_streams_stream_status_void_t
...
func WasiKeyvalueTypesOpenBucket(name string) Result[uint32, uint32] {
  var lower_name C.kvcounter_string_t
  
  lower_name.ptr = C.CString(name)
  lower_name.len = C.size_t(len(name))
  defer C.kvcounter_string_free(&lower_name)
  var ret C.kvcounter_result_wasi_keyvalue_types_bucket_wasi_keyvalue_types_error_t
...
func WasiKeyvalueTypesOutgoingValueWriteBody(outgoing_value uint32) Result[uint32, struct{}] {
  ...
  lower_outgoing_value_val := C.uint32_t(outgoing_value)
  lower_outgoing_value = lower_outgoing_value_val
  var ret C.kvcounter_result_wasi_keyvalue_types_output_stream_void_t
...
func WasiKeyvalueTypesIncomingValueConsumeSync(incoming_value uint32) Result[[]uint8, uint32] {
  ...
  lower_incoming_value_val := C.uint32_t(incoming_value)
  lower_incoming_value = lower_incoming_value_val
  var ret C.kvcounter_result_wasi_keyvalue_types_incoming_value_sync_body_wasi_keyvalue_types_error_t
...
func WasiKeyvalueTypesIncomingValueConsumeAsync(incoming_value uint32) Result[uint32, uint32] {
  ...
  lower_incoming_value_val := C.uint32_t(incoming_value)
  lower_incoming_value = lower_incoming_value_val
  var ret C.kvcounter_result_wasi_keyvalue_types_incoming_value_async_body_wasi_keyvalue_types_error_t
...
func WasiKeyvalueReadwriteGet(bucket uint32, key string) Result[uint32, uint32] {
  ...
  var lower_key_val C.kvcounter_string_t
  var lower_key_val_val C.kvcounter_string_t
  ...
  var ret C.kvcounter_result_wasi_keyvalue_readwrite_incoming_value_wasi_keyvalue_readwrite_error_t
...
func WasiKeyvalueReadwriteSet(bucket uint32, key string, outgoing_value uint32) Result[struct{}, uint32] {
  ...
  lower_outgoing_value = lower_outgoing_value_val
  var ret C.kvcounter_result_void_wasi_keyvalue_readwrite_error_t
...
func WasiKeyvalueReadwriteExists(bucket uint32, key string) Result[bool, uint32] {
  ...
  lower_key = lower_key_val
  defer C.wasi_keyvalue_readwrite_key_free(&lower_key)
  var ret C.kvcounter_result_bool_wasi_keyvalue_readwrite_error_t
...
func WasiKeyvalueAtomicIncrement(bucket uint32, key string, delta uint64) Result[uint64, uint32] {
  ...
  var ret C.kvcounter_result_u64_wasi_keyvalue_atomic_error_t
...
func WasiKeyvalueAtomicCompareAndSwap(bucket uint32, key string, old uint64, new uint64) Result[bool, uint32] {
  ...
  var ret C.kvcounter_result_bool_wasi_keyvalue_atomic_error_t
...
func WasiKeyvalueBatchGetMany(bucket uint32, keys []string) Result[[]uint32, uint32] {
  ...
  if len(keys) == 0 {
    ...
    for lower_keys_val_i := range keys {
      ...
      var lower_keys_val_ptr_value C.kvcounter_string_t
      var lower_keys_val_ptr_value_val C.kvcounter_string_t
  ...
  var ret C.kvcounter_result_list_wasi_keyvalue_batch_incoming_value_wasi_keyvalue_batch_error_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.kvcounter_list_wasi_keyvalue_batch_incoming_value_t)(unsafe.Pointer(&ret.val))
    var lift_ret_val []uint32
...
func WasiKeyvalueBatchSetMany(bucket uint32, keys []string, values []WasiKeyvalueBatchTuple2WasiKeyvalueBatchKeyWasiKeyvalueBatchOutgoingValueT) Result[struct{}, uint32] {
  ...
  lower_keys = lower_keys_val
  defer C.wasi_keyvalue_batch_keys_free(&lower_keys)
  var lower_values C.kvcounter_list_tuple2_wasi_keyvalue_batch_key_wasi_keyvalue_batch_outgoing_value_t
  if len(values) == 0 {
    lower_values.ptr = nil
    lower_values.len = 0
  } else {
    var empty_lower_values C.kvcounter_tuple2_wasi_keyvalue_batch_key_wasi_keyvalue_batch_outgoing_value_t
    lower_values.ptr = (*C.kvcounter_tuple2_wasi_keyvalue_batch_key_wasi_keyvalue_batch_outgoing_value_t)(C.malloc(C.size_t(len(values)) * C.size_t(unsafe.Sizeof(empty_lower_values))))
    lower_values.len = C.size_t(len(values))
    for lower_values_i := range values {
      lower_values_ptr := (*C.kvcounter_tuple2_wasi_keyvalue_batch_key_wasi_keyvalue_batch_outgoing_value_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_values.ptr)) +
      uintptr(lower_values_i)*unsafe.Sizeof(empty_lower_values)))
      var lower_values_ptr_value C.kvcounter_tuple2_wasi_keyvalue_batch_key_wasi_keyvalue_batch_outgoing_value_t
      var lower_values_ptr_value_f0 C.wasi_keyvalue_types_key_t
      var lower_values_ptr_value_f0_val C.kvcounter_string_t
      var lower_values_ptr_value_f0_val_val C.kvcounter_string_t
  ...
  defer C.kvcounter_list_tuple2_wasi_keyvalue_batch_key_wasi_keyvalue_batch_outgoing_value_free(&lower_values)
  var ret C.kvcounter_result_void_wasi_keyvalue_batch_error_t
...
func WasiHttpTypesNewFields(entries []WasiHttpTypesTuple2StringListU8TT) uint32 {
  var lower_entries C.kvcounter_list_tuple2_string_list_u8_t
  if len(entries) == 0 {
    lower_entries.ptr = nil
    lower_entries.len = 0
  } else {
    var empty_lower_entries C.kvcounter_tuple2_string_list_u8_t
    lower_entries.ptr = (*C.kvcounter_tuple2_string_list_u8_t)(C.malloc(C.size_t(len(entries)) * C.size_t(unsafe.Sizeof(empty_lower_entries))))
    lower_entries.len = C.size_t(len(entries))
    for lower_entries_i := range entries {
      lower_entries_ptr := (*C.kvcounter_tuple2_string_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_entries.ptr)) +
      uintptr(lower_entries_i)*unsafe.Sizeof(empty_lower_entries)))
      var lower_entries_ptr_value C.kvcounter_tuple2_string_list_u8_t
      var lower_entries_ptr_value_f0 C.kvcounter_string_t
      ...
      var lower_entries_ptr_value_f1 C.kvcounter_list_u8_t
  ...
  defer C.kvcounter_list_tuple2_string_list_u8_free(&lower_entries)
...
func WasiHttpTypesFieldsGet(fields uint32, name string) [][]uint8 {
  ...
  lower_name.len = C.size_t(len(name))
  defer C.kvcounter_string_free(&lower_name)
  var ret C.kvcounter_list_list_u8_t
  C.wasi_http_types_fields_get(lower_fields, &lower_name, &ret)
  var lift_ret [][]uint8
  lift_ret = make([][]uint8, ret.len)
  if ret.len > 0 {
    for lift_ret_i := 0; lift_ret_i < int(ret.len); lift_ret_i++ {
      var empty_lift_ret C.kvcounter_list_u8_t
      lift_ret_ptr := *(*C.kvcounter_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(ret.ptr)) +
      uintptr(lift_ret_i)*unsafe.Sizeof(empty_lift_ret)))
...
func WasiHttpTypesFieldsSet(fields uint32, name string, value [][]uint8) {
  ...
  lower_name.len = C.size_t(len(name))
  defer C.kvcounter_string_free(&lower_name)
  var lower_value C.kvcounter_list_list_u8_t
  if len(value) == 0 {
    lower_value.ptr = nil
    lower_value.len = 0
  } else {
    var empty_lower_value C.kvcounter_list_u8_t
    lower_value.ptr = (*C.kvcounter_list_u8_t)(C.malloc(C.size_t(len(value)) * C.size_t(unsafe.Sizeof(empty_lower_value))))
    lower_value.len = C.size_t(len(value))
    for lower_value_i := range value {
      lower_value_ptr := (*C.kvcounter_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_value.ptr)) +
  ...
  defer C.kvcounter_list_list_u8_free(&lower_value)
...
func WasiHttpTypesFieldsAppend(fields uint32, name string, value []uint8) {
  ...
  lower_name.len = C.size_t(len(name))
  defer C.kvcounter_string_free(&lower_name)
  var lower_value C.kvcounter_list_u8_t
  if len(value) == 0 {
    lower_value.ptr = nil
    lower_value.len = 0
  } else {
  ...
  defer C.kvcounter_list_u8_free(&lower_value)
...
func WasiHttpTypesFieldsEntries(fields uint32) []WasiHttpTypesTuple2StringListU8TT {
  ...
  lower_fields_val := C.uint32_t(fields)
  lower_fields = lower_fields_val
  var ret C.kvcounter_list_tuple2_string_list_u8_t
  ...
  if ret.len > 0 {
    for lift_ret_i := 0; lift_ret_i < int(ret.len); lift_ret_i++ {
      var empty_lift_ret C.kvcounter_tuple2_string_list_u8_t
      lift_ret_ptr := *(*C.kvcounter_tuple2_string_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(ret.ptr)) +
      uintptr(lift_ret_i)*unsafe.Sizeof(empty_lift_ret)))
...
func WasiHttpTypesFinishIncomingStream(s uint32) Option[uint32] {
  ...
  lower_s = lower_s_val
  var ret C.kvcounter_option_wasi_http_types_future_trailers_t
...
func WasiHttpTypesFutureTrailersGet(f uint32) Option[Result[uint32, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.kvcounter_option_result_wasi_http_types_trailers_wasi_http_types_error_t
  ...
  if ret.is_some {
    ...
    if ret.val.is_err {
      ...
      if lift_ret_val_ptr.tag == 0 {
        lift_ret_val_val_ptr := *(*C.kvcounter_string_t)(unsafe.Pointer(&lift_ret_val_ptr.val))
...
func WasiHttpTypesFutureWriteTrailersResultGet(f uint32) Option[Result[struct{}, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.kvcounter_option_result_void_wasi_http_types_error_t
...
func WasiHttpTypesIncomingRequestMethod(request uint32) WasiHttpTypesMethod {
  ...
  if ret.tag == 9 {
    lift_ret_ptr := *(*C.kvcounter_string_t)(unsafe.Pointer(&ret.val))
    var lift_ret_val string
...
func WasiHttpTypesIncomingRequestPathWithQuery(request uint32) Option[string] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.kvcounter_option_string_t
...
func WasiHttpTypesIncomingRequestScheme(request uint32) Option[WasiHttpTypesScheme] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.kvcounter_option_wasi_http_types_scheme_t
  ...
  if ret.is_some {
    ...
    if ret.val.tag == 2 {
      lift_ret_val_ptr := *(*C.kvcounter_string_t)(unsafe.Pointer(&ret.val.val))
...
func WasiHttpTypesIncomingRequestConsume(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.kvcounter_result_wasi_http_types_incoming_stream_void_t
...
func WasiHttpTypesNewOutgoingRequest(method WasiHttpTypesMethod, path_with_query Option[string], scheme Option[WasiHttpTypesScheme], authority Option[string], headers uint32) Result[uint32, WasiHttpTypesError] {
  ...
  if method.Kind() == WasiHttpTypesMethodKindOther {
    ...
    lower_method.tag = 9
    lower_method_ptr := (*C.kvcounter_string_t)(unsafe.Pointer(&lower_method.val))
    var lower_method_val C.kvcounter_string_t
  ...
  var lower_path_with_query C.kvcounter_option_string_t
  if path_with_query.IsSome() {
    var lower_path_with_query_val C.kvcounter_string_t
  ...
  defer C.kvcounter_option_string_free(&lower_path_with_query)
  var lower_scheme C.kvcounter_option_wasi_http_types_scheme_t
  if scheme.IsSome() {
    ...
    if scheme.Unwrap().Kind() == WasiHttpTypesSchemeKindOther {
      ...
      lower_scheme_val_ptr := (*C.kvcounter_string_t)(unsafe.Pointer(&lower_scheme_val.val))
      var lower_scheme_val_val C.kvcounter_string_t
  ...
  defer C.kvcounter_option_wasi_http_types_scheme_free(&lower_scheme)
  var lower_authority C.kvcounter_option_string_t
  if authority.IsSome() {
    var lower_authority_val C.kvcounter_string_t
  ...
  defer C.kvcounter_option_string_free(&lower_authority)
  ...
  var ret C.kvcounter_result_wasi_http_types_outgoing_request_wasi_http_types_error_t
  ...
  if ret.is_err {
    ...
    if lift_ret_ptr.tag == 0 {
      lift_ret_val_ptr := *(*C.kvcounter_string_t)(unsafe.Pointer(&lift_ret_ptr.val))
      var lift_ret_val_val string
      lift_ret_val_val = C.GoStringN(lift_ret_val_ptr.ptr, C.int(lift_ret_val_ptr.len))
...
func WasiHttpTypesOutgoingRequestWrite(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.kvcounter_result_wasi_http_types_outgoing_stream_void_t
...
func WasiHttpTypesSetResponseOutparam(param uint32, response Result[uint32, WasiHttpTypesError]) Result[struct{}, struct{}] {
  ...
  var lower_response C.kvcounter_result_wasi_http_types_outgoing_response_wasi_http_types_error_t
  ...
  if response.IsOk() {
    ...
    *lower_response_ptr = lower_response_val
    ...
    if response.UnwrapErr().Kind() == WasiHttpTypesErrorKindInvalidUrl {
      ...
      lower_response_val_ptr := (*C.kvcounter_string_t)(unsafe.Pointer(&lower_response_val.val))
      var lower_response_val_val C.kvcounter_string_t
  ...
  defer C.kvcounter_result_wasi_http_types_outgoing_response_wasi_http_types_error_free(&lower_response)
  var ret C.kvcounter_result_void_void_t
...
func WasiHttpTypesNewOutgoingResponse(status_code uint16, headers uint32) Result[uint32, WasiHttpTypesError] {
  ...
  lower_headers_val = lower_headers_val_val
  lower_headers = lower_headers_val
  var ret C.kvcounter_result_wasi_http_types_outgoing_response_wasi_http_types_error_t
...
func WasiHttpTypesFutureIncomingResponseGet(f uint32) Option[Result[uint32, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.kvcounter_option_result_wasi_http_types_incoming_response_wasi_http_types_error_t
